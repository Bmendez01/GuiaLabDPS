    ...
    <>
      <ScrollView>
        ...
        <Modal transparent={true} animationType="slide" visible={modalVisibleplaya} onRequestClose={() => {
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              ...
              <Text>El Salvador cuenta con hermosas playas a nicelde centroamérica</Text>
              <Button title="Cerrar" onPress={() => { setModalVisibleplaya(!modalVisibleplaya) }}></Button>
            </View>
          </View>
        </Modal>

        <Modal transparent={true} animationType="slide" visible={modalVisiblepupas} onRequestClose={() => {
          alert('Modal has been closed');
        }}>
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              <Text style={styles.subtitulo}>PUPAS</Text>
              <Text>Pero que ricas las pupusas</Text>
              <Button title="Cerrar" onPress={() => { setModalVisiblepupas(!modalVisiblepupas) }}></Button>
            </View>
          </View>
        </Modal>
        ...
        <Modal transparent={true} animationType="slide" visible={modalVisiblepueblos} onRequestClose={() => {
          ...
          <View style={styles.vistaModal}>
            <View style={styles.Modal}>
              <Text style={styles.subtitulo}>Visitar pueblos vivos</Text>
              <Text>Pero que vivos los pueblos, madre mía</Text>
        ...
        <View style={styles.contenedor}>
          ...
          <View>
            <View>
              <TouchableHighlight onPress={() => { setModalVisiblepupas(!modalVisiblepupas) }}>
                <Image
